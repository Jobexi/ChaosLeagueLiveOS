...
public class JobexiPlinko : Game, IObsSpawner
{
    [SerializeField] private SpriteRenderer _obsSpawnRegion;
    [SerializeField] private GameObject _obstacle1Prefab;
  //  [SerializeField] private GameObject _obstacle2Prefab;
  //  [SerializeField] private GameObject _obstacle3Prefab;
  //  [SerializeField] private GameObject _obstacle4Prefab;
    ...
    public ChaosObs PlayerObstacleFactory()
    {
        ...
        GameObject playerObstacle1 = Instantiate(_obstacle1Prefab, _chaosObsRoot);
     //   GameObject playerObstacle2 = Instantiate(_obstacle2Prefab, _chaosObsRoot);
     //   GameObject playerObstacle3 = Instantiate(_obstacle3Prefab, _chaosObsRoot);
     //   GameObject playerObstacle4 = Instantiate(_obstacle4Prefab, _chaosObsRoot);
        ChaosObs pov2 = playerObstacle1.GetComponentInChildren<ChaosObs>();

    //    if (rando == 1)
            pov2 = playerObstacle1.GetComponentInChildren<ChaosObs>();
     //   else if (rando == 2)
     //       pov2 = playerObstacle2.GetComponentInChildren<ChaosObs>();
    //    else if (rando == 3)
    //        pov2 = playerObstacle3.GetComponentInChildren<ChaosObs>();
    //    else if (rando == 4)
    //        pov2 = playerObstacle4.GetComponentInChildren<ChaosObs>();
        return pov2;
    }
