...
public class MythicCrownShop : Game
{
    [SerializeField] private List<MythicCrownShopEntry> _entries;
    ...
    {
        _entries[0].InitEntry(_modeOne, _priceOne);
        _entries[1].InitEntry(_modeTwo, _priceTwo);
        _entries[2].InitEntry(_modeThree, _priceThree);
